function [hessian_mat, gg, htol1, ihh, hh_mat0] = hessian_mr(init,x,func,hflag,htol0,varargin)
%  [hessian_mat, gg, htol1, ihh, hh_mat0] = hessian_mr(init,x,func,hflag,htol0,varargin)
%
