function [fhat,xhat,fcount,retcode] = mycsminit(fcn,x0,f0,g0,badg,H0,varargin)
% [fhat,xhat,fcount,retcode] = mycsminit(fcn,x0,f0,g0,badg,H0,...
...
%         disp(sprintf('Correct for low angle: %g',a))
   ...
   % disp(sprintf('Predicted improvement: %18.9f \n ',-dfhat/2))
   %
