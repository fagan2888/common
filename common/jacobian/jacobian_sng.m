...
%
%  [jac,err] = myjacobianest(fun,[1 1 1])
%
%  jac =
%           -2           -2            0
...
% MaxStep = 100;
MaxStep = 10; % otherwise GENSYS returns zero columns
% StepRatio = 2;
StepRatio = 2;
...
%      fun(swapelement(x0,i,x0_i - delta(j)));
    fdif = feval(fun,swapelement(x0,i,x0_i + delta(j)),varargin{:}) - ...
      feval(fun,swapelement(x0,i,x0_i - delta(j)),varargin{:});
